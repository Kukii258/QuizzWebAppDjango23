...
urlpatterns = [
    ...
    path('createQuestions/<int:quiz_id>/', views.createQuestions, name='createQuestions'),
    ...
    path('changePublicity/<int:quiz_id>/', views.changePublicity, name='changePublicity'),
